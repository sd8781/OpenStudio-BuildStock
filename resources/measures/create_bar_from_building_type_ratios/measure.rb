...
# start the measure
class CreateBarFromBuildingTypeRatios < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    bldg_type_a_num_units = OpenStudio::Ruleset::OSArgument.makeIntegerArgument("bldg_type_a_num_units", true)
    ...
    bldg_type_b_fract_bldg_area = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("bldg_type_b_fract_bldg_area", true)
    ...
    bldg_type_b_num_units = OpenStudio::Ruleset::OSArgument.makeIntegerArgument("bldg_type_b_num_units", true)
    ...
    bldg_type_c_fract_bldg_area = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("bldg_type_c_fract_bldg_area", true)
    ...
    bldg_type_c_num_units = OpenStudio::Ruleset::OSArgument.makeIntegerArgument("bldg_type_c_num_units", true)
    ...
    bldg_type_d_fract_bldg_area = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("bldg_type_d_fract_bldg_area", true)
    ...
    bldg_type_d_num_units = OpenStudio::Ruleset::OSArgument.makeIntegerArgument("bldg_type_d_num_units", true)
    ...
    floor_height = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("floor_height", true)
    ...
    num_stories_above_grade = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("num_stories_above_grade", true)
    ...
    num_stories_below_grade = OpenStudio::Ruleset::OSArgument.makeIntegerArgument("num_stories_below_grade", true)
    ...
    building_rotation = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("building_rotation", true)
    ...
    party_wall_fraction = OpenStudio::Ruleset::OSArgument::makeDoubleArgument("party_wall_fraction",true)
    ...
    party_wall_stories_north = OpenStudio::Ruleset::OSArgument::makeIntegerArgument("party_wall_stories_north",true)
    ...
    party_wall_stories_south = OpenStudio::Ruleset::OSArgument::makeIntegerArgument("party_wall_stories_south",true)
    ...
    party_wall_stories_east = OpenStudio::Ruleset::OSArgument::makeIntegerArgument("party_wall_stories_east",true)
    ...
    party_wall_stories_west = OpenStudio::Ruleset::OSArgument::makeIntegerArgument("party_wall_stories_west",true)
    ...
    bottom_story_ground_exposed_floor = OpenStudio::Ruleset::OSArgument::makeBoolArgument("bottom_story_ground_exposed_floor",true)
    ...
    top_story_exterior_exposed_roof = OpenStudio::Ruleset::OSArgument::makeBoolArgument("top_story_exterior_exposed_roof",true)
    ...
    story_multiplier = OpenStudio::Ruleset::OSArgument::makeChoiceArgument("story_multiplier", choices,true)
    ...
    make_mid_story_surfaces_adiabatic = OpenStudio::Ruleset::OSArgument::makeBoolArgument("make_mid_story_surfaces_adiabatic",true)
  ...
  def run(model, runner, user_arguments)
    ...
    if not args['building_rotation'] == initial_rotation
    ...
    if args['party_wall_fraction'] > 0 && party_walls_array.size > 0
      ...
      until width_area + facade_area >= target_party_wall_area or width_counter == args['num_stories_above_grade'].ceil * 2
      ...
      until length_area + facade_area >= target_party_wall_area or length_counter == args['num_stories_above_grade'].ceil * 2
        # update facade area for top story
      ...
      if not [90.0,270.0].include? best_fit
    ...
    num_stories_round_up.times do |i|
      ...
      bar_hash[:stories]["key #{i.to_s}"] = {:story_party_walls=>party_walls, :story_min_multiplier=> 1, :story_included_in_building_area => true, :below_partial_story => below_partial_story, :bottom_story_ground_exposed_floor => args['bottom_story_ground_exposed_floor'], :top_story_exterior_exposed_roof => args['top_story_exterior_exposed_roof']}
    end
    ...
    # check expected floor areas against actual
      model.getSpaceTypes.sort.each do |space_type|
        next if not target_areas.has_key? space_type
        ...
        if not (space_type.floorArea - target_areas[space_type]).abs < 1.0

          if not args["bar_division_method"].include? "Single Space Type"
