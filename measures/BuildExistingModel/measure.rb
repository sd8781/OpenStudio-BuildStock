...
class BuildExistingModel < OpenStudio::Ruleset::ModelUserScript
  ...
  def run(model, runner, user_arguments)
    ...
    parameters_ordered = get_parameters_ordered_from_options_lookup_tsv(resources_dir, characteristics_dir, 'options_lookup_comstock')
    if parameters_ordered.empty?
      runner.registerError('No parameters were found.  Ensure that the options_lookup or options_lookup_comstock file is available.')
      return false
    end
